...
StaticGameObject::StaticGameObject(GpuFunctions *gpu_functions, Object *object, TextureType texture_type, int texture_id, LightType light_type, glm::mat4 model)
    : GameObject(gpu_functions, model, object, texture_type, light_type)
{
